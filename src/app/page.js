                ...
                <div className="flex flex-col">
                    ...
                    <div className="h-[50%] py-56 flex items-center justify-center bg-purple-300">
                        <div className="relative flex flex-col items-center">
                            <a href="/Shaélah_ZEBATO_CV2025.pdf" download className="absolute md:-right-20 -top-16 bg-purple-950 text-purple-400 text-lg py-3 px-6 rounded-lg shadow-lg transition-all hover:bg-purple-800 hover:text-white hover:scale-105">
                                Télécharger Cv
                            </a>
